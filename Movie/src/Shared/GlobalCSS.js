...
export const styles = StyleSheet.create({
  ...
  deleteView: { backgroundColor: 'black', alignSelf: 'flex-end', marginEnd: 10, marginTop: 10, borderRadius: 12 },
  deleteText: { fontSize: 14, fontWeight: 'bold', padding: 5, color: '#fff' },
  searchBar: { backgroundColor: '#fff', marginHorizontal: 10 }
});